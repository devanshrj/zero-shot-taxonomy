"""
MaskedLM with prompts + Restricted target vocabulary (target_vocab = input_terminology)
"""
...
def get_taxo(args, model, tokenizer, device, domain, prompt):
    ...
    target_vocab = get_target_vocab(tokenizer, terms).to(device)
    ...
    for focus in progress_bar:
        ...
        target_preds = mask_preds * target_vocab

        top_ids = target_preds.topk(10)[1]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--method-name", default="restrict-mlm", type=str)
